...
package ece383_pkg is
  ...
  -- Game Map Type def --
  type map_array is array (0 to 19) of std_logic_vector(1 downto 0);
  ...
  constant MAGENTA : color_t := x"FF00CC"; -- had to change from FF00E1 because my pallate does not have that color, but reads it as this color
  
  constant LGRASS : color_t := x"A1D357";
  constant DGRASS : color_t := x"A9DB5F";
  constant ROAD   : color_t := x"494F5F";
  constant WATER  : color_t := x"81D8FF";
