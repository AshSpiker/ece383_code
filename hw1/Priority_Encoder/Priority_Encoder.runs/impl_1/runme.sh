...
HD_PWD='C:/Users/C28Asher.Speicher/Documents/ece383_code/hw1/Priority_Encoder/Priority_Encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simulated_priority_encoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simulated_priority_encoder.tcl -notrace
