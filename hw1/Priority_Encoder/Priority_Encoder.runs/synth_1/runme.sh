...
HD_PWD='C:/Users/C28Asher.Speicher/Documents/ece383_code/hw1/Priority_Encoder/Priority_Encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simulated_priority_encoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simulated_priority_encoder.tcl
